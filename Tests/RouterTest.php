...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->loader = $this->createMock('Symfony\Component\Config\Loader\LoaderInterface');
    ...
    public function testMatcherIsCreatedIfCacheIsNotConfigured($option)
    {
        ...
        $this->loader->expects($this->once())
            ...
            ->will($this->returnValue($this->createMock('Symfony\Component\Routing\RouteCollection')));
